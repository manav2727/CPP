...
void solve(){
    ...
    // If sum1 % x == 0....it means, either all numbers are divisible by x, 
    // or even number of non divisibe numbers are there. Therefore, 
    // get position of 1st non-divisible from either left and right, 
    // and see the maximum length.
}
