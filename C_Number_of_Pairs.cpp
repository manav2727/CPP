...
void solve(){
    ...
    //1 2 3 4 5 - arr, if range was - 3 to 5
    // then for 1, 
    // cout<<lower_bound(arr.begin(),arr.end(),2) - arr.begin()<<"\n";.....3-1=2
    // cout<<upper_bound(arr.begin(),arr.end(),4) - arr.begin()<<"\n";.....5-1=4
    // lb - 1  ub - 4, i.e. 4 is allowed maximum of arr, therefore we return the next index,
    // which we cannot take, as 1+that no will be > 5
    cout<<ans<<"\n";
}
