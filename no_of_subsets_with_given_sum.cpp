...
void LetsSolveIt(){
    ...
    // last row shows all the subset sums that can be made till that sum
    // and last cell shows how many subsets of that sum can be made
    // if we want all subset sums, we can count the sum of array and use it as x
    // then last row will give us all the subset sums
}
