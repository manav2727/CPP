...
void LetsSolveIt(){
    ...
    // 3 5 6 1 2 4
    // all no. > 3 will be removed by 3
    // ll no.s < 3 will be removed by 4
    // and finally 3 will be removed by 4 or vice versa

    // if 4 5 6 1 2 3
    // all no.s > 4 can be removed by 4
    // all no.s < 3 can be removed by 3
    // BUT 4 CANNOT BE REMOVED BY 3 AND VICE VERSA(4 3)
