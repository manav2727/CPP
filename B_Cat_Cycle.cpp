...
void solve(){
    ...
    k--;
    ll intervals = n/2; // mid
    ll gaps = k/intervals;
    cout<<(k + gaps)%n + 1<<"\n"; // (no. of gaps + k)th position
    // Eg. n=5 k=10
    // for A => 5 4 3 2 1
    //          10 9 8 7 6    // right to left
    // for B => 1 2 x 3 4
    //          x 5 6 x 7 
    //          8 x 9 10      // Total 14 - k + 4 gaps(x)
    // gaps is coming after every n/2 interval.... and total gaps will be k/interval
}
