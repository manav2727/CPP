...
// Basically staircases can be made if I have.....
// First can be made from 1 cell, another from 6 cells(3 staircase)
// Then from 28 cells(7 staircases)
// After every 2^i base cell, 1(2^0), 3(2^0+2^1), 7(2^0+2^1+2^2)...i += sum2 
// Initially i=1, then sum2 = 2, then i = 3(1+2), then sum2 = 4, then i = 7(1+2+4)
// Before 35 and after 7, only 2 staircases can be made(different) ... 35=1+6+28 so 3
